...
<body>
    ...
    <div class="container">
        <nav class="navbar navbar-expand-lg navbar-light">
            <div class="container-fluid">
                <a class="navbar-brand" href="#">NatuChoco</a>
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    ...
                    <ul class="navbar-nav">
                        <?php if ($Id) : ?>
                            ...
                            <button type="button" style="border:none; background:none; position:relative; right:-500px;" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal">
                                <i class="bi bi-person-circle" style="color: #000;"></i>
                            </button>

                            <h6 style="position:relative; top:10px; right:-500px;"> <?php echo $User ?> </h6>

                        <?php else : ?>
                            <ul class="navbar-nav">

                                <a href="Login.php" style="right:-550px; position:relative;"> <i class="bi bi-person-circle" style="color: #000;"></i>
                                </a>
                            </ul>
                        <?php endif; ?>
                    </ul>
    ...
    <header class="bg-dark py-5">
        <div class="container px-4 px-lg-5 my-5">
            <div class="text-center text-white">
                <h1 class="display-4 fw-bolder">Tienda NatuChocó</h1>
                <p class="lead fw-normal text-white-50 mb-0"><b>Ofreciendo siempre un servicio agradable y duradero a beneficio de los Chocoanos</b></p>
            </div>
        </div>
    </header>
    ...
    <footer class="py-5 bg-dark">
        <div class="container">
            <p class="m-0 text-center text-white">Copyright &copy; NatuChocó 2023</p>
        </div>
    </footer>
    <!-- Bootstrap core JS-->
